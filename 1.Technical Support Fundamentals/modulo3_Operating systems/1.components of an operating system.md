# Study Guide: Module 3 – Operating Systems 🖥️
...
- **Notes:** Free, modifiable, distributed as "distributions" (Ubuntu, Debian, Red Hat).
- **IT Support Note:** Linux knowledge applies to servers, Chrome OS, and Android.

### 2.4 Chrome OS & Android 🌍
- **Developer:** Google
- **Notes:** Both run on the Linux kernel; Chrome OS for desktops/laptops, Android for mobile.
