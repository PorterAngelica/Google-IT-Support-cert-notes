...
---
# Supplemental Reading: Projectors

Projectors are **display devices** used to share information with groups of people in the same location.  
They work much like monitors, but with some unique considerations.  

Like other displays, projectors can develop:
...
To connect a projector, use one of the common display cables:
- **VGA**
- **DVI**
- **HDMI**
- **DisplayPort**

Once connected, the operating system will detect a new display.  
Depending on the **video adapter**, the projector can be set as:
- **Extended display**  
- **Mirrored display** (duplicate of screen)  
...
- **macOS** – [Connect one or more external displays](https://support.apple.com/guide/mac-help/connect-an-external-display-mchl7c7ebe08/14.0/mac/14.0)  
- **Ubuntu** – [How to connect another monitor](https://help.ubuntu.com/stable/ubuntu-help/display-dual-monitors.html)  

⚠️ **Troubleshooting Tip:**  
Projector display issues are often caused by **worn/damaged cables or connectors**, since they are frequently plugged/unplugged. Always check these first if the image flickers or disappears.  

---

## Device Drivers
- If the computer does not recognize the projector resolution, it may default to **low-resolution VGA mode** (e.g., 640×480 or 1024×768).  
- In this case, install/update the **projector’s device driver** from the manufacturer’s support site.  

---

## Lighting
Projectors use different lighting technologies:

- **Incandescent Bulbs (Lamps):**
  - Very bright but run **hot and expensive**
  - If too hot, projector **shuts down**
  - If lamp burns out, projector won’t work  
...
## Calibration
After installation, reset, or moving, projectors often need **calibration**:
